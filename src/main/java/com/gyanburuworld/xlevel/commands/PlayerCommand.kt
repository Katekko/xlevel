...
object PlayerCommand {
    fun showStatus(player: Player) {
        ...
        player.sendMessage(ChatColor.DARK_RED.toString() + " Name: " + ChatColor.GRAY + playerDao.nickname)
    ...
    fun infoWarrior(player: Player) {
        player.sendMessage(ChatColor.YELLOW.toString() + "[xLevel - " + ChatColor.BOLD + "Warrior" + ChatColor.YELLOW + "]")
